 ...
 */
public class SpeechController implements TalkBackPlusService.KeyEventListener {
    ...
    /** The parent service. */
    private final TalkBackPlusService mService;
    ...
    public SpeechController(TalkBackPlusService context,
                            FeedbackController feedbackController) {
        if (feedbackController == null) throw new IllegalStateException();

        mService = context;
        mService.addServiceStateListener(new TalkBackPlusService.ServiceStateListener() {
            @Override
            public void onServiceStateChanged(int newState) {
                if (newState == TalkBackPlusService.SERVICE_STATE_ACTIVE) {
                    setProximitySensorState(true);
                } else if (newState == TalkBackPlusService.SERVICE_STATE_SUSPENDED) {
