...
public final class TextFormatters {
    ...
    public static final class ChangedTextFormatter
        ...
        @Override
        public boolean format(AccessibilityEvent event, TalkBackPlusService context,
                              Utterance utterance) {
        ...
        private void notifyMaxLengthReached(AccessibilityEvent event,
                                            TalkBackPlusService context, Utterance utterance) {
        ...
        private int formatInternal(AccessibilityEvent event, TalkBackPlusService context,
                                   Utterance utterance) {
    ...
    public static final class SelectedTextFormatter
        ...
        private boolean formatInternal(AccessibilityEvent event, TalkBackPlusService context,
                                       Utterance utterance) {
        ...
        private CharSequence getUnselectedText(TalkBackPlusService context, AccessibilityEvent event,
        ...
        private CharSequence getSelectedText(TalkBackPlusService context, AccessibilityEvent event,
                                             CharSequence text, int fromIndex, int toIndex,
                                             int lastToIndex) {
         ...
         */
        private CharSequence getSubsequence(TalkBackPlusService context,
    ...
    private static boolean shouldSpeakPasswords(TalkBackPlusService service) {
        if (service == null) {
            return false;
        }
