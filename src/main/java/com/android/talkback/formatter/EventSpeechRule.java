...
public class EventSpeechRule {
    ...
    private final TalkBackPlusService mContext;
     ...
     */
    private EventSpeechRule(TalkBackPlusService context, Node node, int ruleIndex) {
        mContext = context;
        mNode = node;
     ...
     */
    public static ArrayList<EventSpeechRule> createSpeechRules(TalkBackPlusService context,
    ...
    private class DefaultFilter implements AccessibilityEventFilter {
        ...
        @Override
        public boolean accept(AccessibilityEvent event, TalkBackPlusService context) {
    ...
    public interface AccessibilityEventFilter {
         ...
         */
        boolean accept(AccessibilityEvent event, TalkBackPlusService context);
    }
    ...
    public interface ContextBasedRule {
         ...
         */
        public void initialize(TalkBackPlusService context);
    }
}
