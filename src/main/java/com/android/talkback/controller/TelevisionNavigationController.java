 ...
 */
public class TelevisionNavigationController implements TalkBackPlusService.KeyEventListener {
    ...
    public TelevisionNavigationController(TalkBackPlusService service) {
        mService = service;
