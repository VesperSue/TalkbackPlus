...
class RuleUnlabeledImage implements NodeMenuRule {
    ...
    @Override
    public boolean accept(TalkBackPlusService service, AccessibilityNodeInfoCompat node) {
    ...
    @Override
    public List<ContextMenuItem> getMenuItemsForNode(TalkBackPlusService service,
    ...
    private static class UnlabeledImageMenuItemClickListener
        ...
        public UnlabeledImageMenuItemClickListener(
                TalkBackPlusService service, AccessibilityNodeInfoCompat node, Label label) {
            mContext = service;
            mNode = node;
