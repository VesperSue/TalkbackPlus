...
public class SideTapManager extends BroadcastReceiver
    ...
    /**
     * @param context TalkBackPlusService whose {@code performCustomGesture}
     * will be called when taps are detected
     */
    public SideTapManager(TalkBackPlusService context, GestureController gestureController) {
    ...
    public void onSingleTap(long timeStamp) {
        boolean talkBackActive = TalkBackPlusService.isServiceActive();
