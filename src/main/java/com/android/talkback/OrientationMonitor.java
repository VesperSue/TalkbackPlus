...
public class OrientationMonitor {
    ...
    public OrientationMonitor(SpeechController speechController, TalkBackPlusService context) {
    ...
    /**
     * Called by {@link TalkBackPlusService} when the configuration changes.
     *
