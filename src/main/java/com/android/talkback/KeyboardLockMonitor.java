 ...
 */
public class KeyboardLockMonitor implements TalkBackPlusService.KeyEventListener {

    private final SpeechController mSpeechController;
    private final Context mContext;

    public KeyboardLockMonitor(SpeechController speechController, TalkBackPlusService context) {
