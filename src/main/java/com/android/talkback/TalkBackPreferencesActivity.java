...
public class TalkBackPreferencesActivity extends Activity {
    ...
    public static class TalkBackPreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            assignButtonPositionSettingsIntent();
            ...
            if (TalkBackPlusService.isInArc()) {
        ...
        public void onResume() {
            ...
            if (talkBackPlusService != null) {
                talkBackPlusService.addServiceStateListener(mServiceStateListener);
                if (talkBackPlusService.supportsTouchScreen()) {
        ...
        public void onPause() {
            ...
            TalkBackPlusService talkBackPlusService = TalkBackPlusService.getInstance();
            if (talkBackPlusService != null) {
                talkBackPlusService.removeServiceStateListener(mServiceStateListener);
            }
            Activity activity = getActivity();
        ...
        private void assignTtsSettingsIntent() {
            ...
            Intent ttsSettingsIntent = new Intent(TalkBackPlusService.INTENT_TTS_SETTINGS);
         ...
         * Assigns the intent to open text-to-speech settings.
         */
        private void assignButtonPositionSettingsIntent() {
//            PreferenceGroup category = (PreferenceGroup) findPreferenceByResId(
//                    R.string.pref_category_button_key);
//            Preference buttonSettingsPreference =
//                    findPreferenceByResId(R.string.pref_button_position_key);
//
//            if (category == null || buttonSettingsPreference == null) {
//                return;
//            }
//
//            Intent buttonSettingsIntent = new Intent();
//            buttonSettingsIntent.setClass(getActivity(),SettingActivity.class);
//            buttonSettingsIntent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
//            if (!canHandleIntent(buttonSettingsIntent)) {
//                // Need to remove preference item if no TTS Settings intent filter in settings app.
//                category.removePreference(buttonSettingsPreference);
//            }
//
//            buttonSettingsPreference.setIntent(buttonSettingsIntent);
        }
        ...
        private void updateTalkBackShortcutStatus() {
            ...
            if (Build.VERSION.SDK_INT >= ProcessorVolumeStream.MIN_API_LEVEL) {
                preference.setEnabled(
                        TalkBackPlusService.getInstance() != null || preference.isChecked());
            } else {
                final PreferenceGroup category = (PreferenceGroup) findPreferenceByResId(
                        R.string.pref_category_miscellaneous_key);
                if (category == null) {
        ...
        private void updateDimingPreferenceStatus() {
            ...
            final TalkBackPlusService talkBack = TalkBackPlusService.getInstance();
            ...
            dimPreference.setEnabled(
                    TalkBackPlusService.isServiceActive() || dimPreference.isChecked());
            dimPreference.setOnPreferenceChangeListener(new OnPreferenceChangeListener() {
                ...
                public boolean onPreferenceChange(Preference preference, Object newValue) {
                    ...
                    if (dimPreferenceOn) {
                        ...
                        if (!TalkBackPlusService.isServiceActive()) {
         ...
         * updates atomically.
         *
         * TODO: Move this method to TalkBackPlusService.
         */
...
/*
        ...
        private boolean setTouchExplorationRequested(boolean requestedState) {
            ...
            if(requestedState && TalkBackPlusService.getInstance() != null) {
                TalkBackPlusService.getInstance().showTutorial();
            }
         ...
         * enable or disabled.
         */
        private final TalkBackPlusService.ServiceStateListener mServiceStateListener =
                new TalkBackPlusService.ServiceStateListener() {
                    @Override
