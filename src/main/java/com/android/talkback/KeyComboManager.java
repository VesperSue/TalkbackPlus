...
public class KeyComboManager implements TalkBackPlusService.KeyEventListener,
        TalkBackPlusService.ServiceStateListener {
    ...
    private static final boolean IS_IN_ARC = TalkBackPlusService.isInArc();
    ...
    private TalkBackServiceStateHelper mServiceStateHelper;
    ...
    private KeyComboManager(Context context) {
        ...
        mServiceStateHelper = new TalkBackServiceStateHelperApp();
    ...
    /**
     * Sets TalkBackServiceStateHelper for testing.
     */
    void setTalkBackServiceStateHelperForTesting(
            TalkBackServiceStateHelper serviceStateHelper) {
    ...
    public void onServiceStateChanged(int newState) {
        // Unfortunately, key events are lost when the TalkBackPlusService becomes active. If a key-down
    ...
    private class TalkBackServiceStateHelperApp implements TalkBackServiceStateHelper {
        @Override
        public boolean isServiceActive() {
            return TalkBackPlusService.isServiceActive();
        }
    }
}
