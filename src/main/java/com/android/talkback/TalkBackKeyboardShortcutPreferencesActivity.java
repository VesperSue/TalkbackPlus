...
public class TalkBackKeyboardShortcutPreferencesActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        KeyComboManager keyComboManager = talkBackPlusService == null ?
                KeyComboManager.create(this) : talkBackPlusService.getKeyComboManager();
    ...
    public static class TalkBackKeyboardShortcutPreferenceFragment extends PreferenceFragment {
        ...
        private KeyComboManager getKeyComboManager() {
            TalkBackPlusService talkBackPlusService = TalkBackPlusService.getInstance();
            return talkBackPlusService == null ? KeyComboManager.create(getActivity()) :
                    talkBackPlusService.getKeyComboManager();
        }
